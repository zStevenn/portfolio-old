...
function Contact() {
	return (
		<div className="px-8 py-20 bg-neutral-900 grid gap-4 md:grid-cols-2 min-h-screen" id="contact">
			<h1 className="text-neutral-100 text-2xl font-semibold md:col-span-2"># Contact</h1>
			...
			<div className="text-neutral-100 text-2xl text-center py-4 md:hidden">Of</div>
