function Hero() {
	return (
		<div className="grid grid-cols-1 place-items-center min-h-[75vh]">

		<div className="text-slate-50 px-6 text-center" id="hero">
			...
			<h1 className="text-3xl tracking-wide mb-4">Softwaredeveloper</h1>
