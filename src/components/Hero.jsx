...
function Hero() {
	const textRef = useFadeIn("left")
	const imageRef = useFadeIn("right")

	return (
		<div
			className="bg-neutral-900 grid grid-cols-1 gap-4 py-20 sm:grid-cols-2 px-8 sm:place-items-center min-h-screen container mx-auto"
			id="hero"
		>
			<div ref={textRef} className="text-neutral-100 grid gap-1 sm:gap-2">
			...
			<img
				...
				alt="Steven Li"
			/>
			<div className="sm:col-span-2 text-neutral-100">knoppies</div>
		</div>
	)
}
