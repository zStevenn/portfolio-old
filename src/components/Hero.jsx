			...
			<div className="text-slate-50 w-full grid sm:place-items-center">
				...
				<div className="flex justify-start gap-8">
					<a
						...
						className="px-2 py-2 rounded bg-red-500 border-b-2 border-r-2 border-red-800 text-slate-50 text-lg"
					>
						Download CV
					</a>
					<a
						href="#projecten"
						className="px-2 py-2 rounded bg-gray-500 border-b-2 border-r-2 border-gray-800 text-slate-50 text-lg"
					>
						Projecten
					</a>
				</div>
